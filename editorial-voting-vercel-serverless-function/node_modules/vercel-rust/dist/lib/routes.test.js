...
describe('generateRoutes', () => {
    it('should filter out entry point route', () => {
        ...
        expect((0, routes_1.generateRoutes)(staticRoutes)).toMatchInlineSnapshot(`
      [
        {
          "dest": "/api/bar/baz",
          "path": "api/bar/baz",
    ...
    it('should generate dynamic routes', () => {
        ...
        expect((0, routes_1.generateRoutes)(dynamicRoutes)).toMatchInlineSnapshot(`
      [
        {
    ...
    it('should generate catch-all routes', () => {
        ...
        expect((0, routes_1.generateRoutes)(catchAllRoutes)).toMatchInlineSnapshot(`
      [
        {
          "dest": "/api/all/[...all]",
          "path": "api/all/[...all]",
